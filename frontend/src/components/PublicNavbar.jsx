        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            {user ? (
              ...
              <>
                <Link to="/login" className="hidden sm:inline-flex text-sm text-gray-300 hover:text-white transition font-medium px-4 py-2 rounded-lg border border-transparent hover:bg-white/5">
                  Sign In
                </Link>
